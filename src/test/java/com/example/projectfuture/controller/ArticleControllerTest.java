...
import com.example.projectfuture.domain.constant.FormStatus;
...
import com.example.projectfuture.request.ArticleRequest;
import com.example.projectfuture.response.ArticleResponse;
import com.example.projectfuture.service.ArticleService;
import com.example.projectfuture.service.PaginationService;
import com.example.projectfuture.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    public void givenNothing_whenRequestingArticlesSearchHashtagView_thenReturnsArticlesHashtagSearchView() throws Exception {
        //Given
    ...
    @DisplayName("[View] [Get] 게시글 해시태그 검색 전용 페이지 - 정상호출")
    @Test
    public void givenHashtag_whenRequestingArticlesSearchHashtagView_thenReturnsArticlesHashtagSearchView() throws Exception {
        //Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");

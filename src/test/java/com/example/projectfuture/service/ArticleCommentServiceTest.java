...
class ArticleCommentServiceTest {
    ...
    @Test
    void givenArticleCommentInfo_whenSavingArticleComment_thenSavesArticleCommnet() {
        //Given
    ...
    @Test
    void givenAricleCommentInfo_whenUpdatingArticleCommnet_thenUpdatesArtilceCommnet() {
        //Given
    ...
    @DisplayName("없는 댓글 정보를 수정하려고하면, 경고 로그를 찍고 아무것도 안한다.")
    @Test
    void givenNonexistentArticleComment_whenUpdatingArticleCommnet_thenLogsWarningAndDoesNothing() {
        //Given
        ArticleCommentDto dto = createArticleCommentDto("댓글");
    ...
    @Test
    void givenArticleCommentId_whenDeletingArticleComment_thenDeletesArticlesComment() {
        //Given
